...
export interface User {
    ...
    ms_user_id?: string;
    email: string;
    password_hash?: string; // For mock auth, will be null when MS SSO is implemented
    name: string;
    is_coach: boolean;
    is_lead: boolean;
    is_admin: boolean;
...
export interface Engineer {
    ...
    is_active: boolean;
    created_at: string;
    lead_name?: string; // For joined queries
    coach_name?: string; // For joined queries with coach assignments
}
